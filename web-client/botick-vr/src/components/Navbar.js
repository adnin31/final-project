          ...
          <div className = "container">
            ...
            <div className = "navbar-collapse collapse" id = "bs-example-navbar-collapse-1" aria-expanded="false" style={{height: 1}}>
              <ul className= 'nav navbar-nav col-md-5'>
                <li style={{display: 'flex', alignItems: 'baseline', padding: '0 5%'}}><span className= 'glyphicon glyphicon-tag'></span> <a className= 'btn'> Coming Soon </a></li>
                <li style={{display: 'flex', alignItems: 'baseline', padding: '0 5%' }}><span className= 'glyphicon glyphicon-film'></span><a className= 'btn'> Trailer </a></li>
              </ul>
